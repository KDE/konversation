...
Rectangle {
    ...
    width: Kirigami.Settings.isMobile ? 2 * Kirigami.Units.gridUnit : Kirigami.Units.gridUnit
    height: Kirigami.Settings.isMobile ? 4 * Kirigami.Units.gridUnit : 3 * Kirigami.Units.gridUnit
