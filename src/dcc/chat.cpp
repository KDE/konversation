    ...
    namespace DCC
    {
        ...
        void Chat::start()
        {
            ...
            if (m_selfOpened)
            {
                ...
                {
                    listenForPartner();
                    callMethodIfDccUpnp(this, &Chat::sendRequest, server, m_ownPort);
                }
            }
            else
            {
                ...
                if (m_reverse)
                {
                    ...
                    listenForPartner();
                    callMethodIfDccUpnp(this, &Chat::sendReverseAck, server, m_ownPort);
                }
                else
                {
                    connectToPartner();
        ...
        bool Chat::setEncoding(const QString &encoding)
        {
            ...
            {
                m_encoding = encoding;
                if (QTextCodec *codec = QTextCodec::codecForName(m_encoding.toLatin1()))
                {
