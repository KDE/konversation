              ...
              KListView(parent)
{
  ...
  QWhatsThis::add(this, i18n("<qt>This shows all the people in the channel.  The nick for each person is shown, with a picture showing their status.<p>"
			  ...
			  "<tr><th><img src=\"admin\"></th><td>This shows that this person has administrator privillages.</td></tr>"
			  "<tr><th><img src=\"owner\"></th><td>This shows that this person is the channel owner.</td></tr>"
			  "<tr><th><img src=\"op\"></th><td>This shows that this person is a channel operator.</td></tr>"
			  "<tr><th><img src=\"halfop\"></th><td>This shows that this person is a channel half-operator.</td></tr>" 
			  "<tr><th><img src=\"voice\"></th><td>This shows that this person has voice, and can therefore talk in a moderated channel.</td></tr>"
			  "<tr><th><img src=\"normal\"></th><td>This shows that this person does not have any special privillages.</td></tr>"
